            ...
            <Table sx={{ minWidth: 650 }} aria-label="a dense table" size='small'>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.inicioTarefa.split('-').reverse().join(" / ")}</TableCell>
                      <TableCell align="right">{row.fimTarefa.split('-').reverse().join(" / ")}</TableCell>
                      <TableCell align="right">{row.statusTarefa}</TableCell>
                      <TableCell align="right">{row.recursoTarefa}</TableCell>
                      <TableCell align="center">
                        <Button variant="contained" color="success" onClick={() => handleEditar(row.idTarefa)}> <I.Edit /> </Button>            
                      </TableCell>
                      <TableCell align="center">
                        <Button variant="contained" color="error" onClick={() => handleDeletar(row.idTarefa)}> <I.Delete /> </Button>            
                      </TableCell>
                    </TableRow>
                ))}
                </TableBody>

        ...
        <CardContent sx={{
          ...
          <Grid item xs={12}>
            <FormControl fullWidth>
              ...
              <TextField id="tarefa_titulo" label="Título da Tarefa" variant="outlined" value={tituloTarefa} onChange={e => { setTituloTarefa(e.target.value) }} />
          ...
          <Grid item xs={12} my={2}>
            <FormControl fullWidth>
              ...
              <TextField  id="tarefa_descricao" label="Descrição da Tarefa" variant="outlined" value={descricaoTarefa} onChange={e => { setDescricaoTarefa(e.target.value) }} />
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid container spacing={1} pl={2} mt={2}>
              <Grid item>
